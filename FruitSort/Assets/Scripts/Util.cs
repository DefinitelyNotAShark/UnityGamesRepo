...
public class Util : MonoBehaviour { 
    ...
    public static Vector3 BounceOffWalls(Vector3 position, float width, float height, ref Vector2 direction)//i don't even need to use this
    {
